...
function iniciar() {
    ...
    cargarAsync("nombre=Binta&apellidos=Diop Diop");
}
/////////////////////////////////////////////////////////
...
function cargarAsync(parametros) {
    if (miXHR) {
        ...
        document.getElementById("indicador").innerHTML = "<img src='assets/img/ajax-loader.gif'/>";
...
/*function cargarAsync(url) {
    if (miXHR) {
        // Activamos el indicador Ajax antes de realizar la petición.
        document.getElementById("indicador").innerHTML = "<img src='assets/img/ajax-loader.gif' width='30' />";
